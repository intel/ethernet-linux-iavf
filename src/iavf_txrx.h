...
/**
 * iavf_intrl_usec_to_reg - convert interrupt rate limit to register
 ...
 */
static inline u16 iavf_intrl_usec_to_reg(int intrl)
{
	if (intrl >> 2)
...
/**
 * txring_txq - Find the netdev Tx ring based on the iavf Tx ring
