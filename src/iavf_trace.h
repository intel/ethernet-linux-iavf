...
/* If the Linux kernel tracepoints are not available then the iavf_trace*
 * macros become nops.
 */

#define iavf_trace(trace_name, args...)
#define iavf_trace_enabled(trace_name) (0)
#endif /* !defined(_IAVF_TRACE_H_) */
